...
abstract class AbandonedCart implements ActiveRecordInterface
{
    ...
    /**
     * The value for the email_client field.
     * @var        string
     */
    ...
    /**
     * Get the [email_client] column value.
     *
     * @return   string
     */
    ...
    /**
     * Get the [login_token] column value.
     *
     * @return   string
     */
     ...
     * @return void
     * @throws PropelException
     * @see AbandonedCart::setDeleted()
     * @see AbandonedCart::isDeleted()
     */
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'CART_ID':
                        ...
                        break;
                    case 'EMAIL_CLIENT':
                        $stmt->bindValue($identifier, $this->email_client, PDO::PARAM_STR);
                        break;
                    case 'LOCALE':
